...
<body>
    ...
    <div class="content">
        <?php
        if (!empty($dados)):
            $entity = $dados[0]->tabela;
        endif;
        ?>
        <div class="section-title os-title">RELATÓRIO FINANCEIRO - <?= $entity == 'pag' || $entity == 'pagsaldo' ? "A PAGAR" : "A RECEBER"; ?></div>
        <div class="section">
            <div class="info">
                <?php
                if (!empty($periodo)):
        ...
        ?>
            <table class="table table-hover bordered tabela-relatorio tab-rel-medicao-cli">
                <thead>
                    ...
                    <tr>
                        <th><?= $entity == 'pag' || $entity == 'pagsaldo' ? "Fornecedor" : "Cliente"; ?></th>
                        <th>OP</th>
                        <th>Título</th>
                        <th>Emissão</th>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            <td><?= $d->entidade_nome; ?></td>
                            <td><?= $d->operacao; ?></td>
                            <td><?= $d->titulo; ?></td>
                            <td><?= $d->datacad; ?></td>
                            <td style="text-align: right;"><?= $d->dataven; ?></td>
                            <td style="text-align: right;"><?= !empty($d->databaixa) ? $d->databaixa : ""; ?></td>
