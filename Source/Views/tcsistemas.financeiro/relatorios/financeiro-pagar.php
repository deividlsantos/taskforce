...
?>
<form method="post" class="form-cadastros form-financeiro-rel" id="pagrel-form" action="<?= url("financeirorel/resultados") ?>">
    <input type="hidden" name="page" value="1" id="page">
    <input type="hidden" name="tabela" value="pag">
            ...
            <div class="fcad-form-row">
                <div class="fcad-form-group coluna60">
                    ...
                    <select id="servicosrel-order1" name="order1" class="order-select">
                        <option value="id_entf">FORNECEDOR</option>
