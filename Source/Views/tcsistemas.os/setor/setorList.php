...
<div class="container-fl-review">
    <div class="fcad-form-row">
        <a href="<?= url("setor/form") ?>" class="btn btn-success"><i class="fa fa-plus"></i></a>
    ...
    <div class="input-filtrar">
        <div class="fcad-form-row">
            ...
            <div style="margin-left:-50px;" class="fcad-form-group coluna30">
                <input type="text" id="filtrarSetor" name="filtrar" value="">
            </div>
        </div>
    </div>
    <div class="tabela-responsive">
        <table id="setor-list" class="tab-list table table-hover bordered table-vendas">
            <thead>
                <tr>
