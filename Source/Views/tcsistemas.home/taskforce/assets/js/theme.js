...
----------------------------------- */
	...
	$('[data-countdown]').each(function () {
		...
		$this.countdown(finalDate, function (event) {
			$this.php(event.strftime('<span class="cdowns days"><span class="time-counts">%-D</span> <p>Days</p></span> <span class="cdowns hour"><span class="time-counts">%-H</span> <p>Hour</p></span> <span class="cdowns minutes"><span class="time-counts">%M</span> <p>Min</p></span> <span class="cdowns second"> <span><span class="time-counts">%S</span> <p>Sec</p></span>'));
		});
	});
...
$(document).ready(function () {
	function rolagem(id) {
		...
		$('a[href="' + id + '"]').on("click", function (e) {
			...
			var target = $(id);
			var offset = 100; // Margem de 20px acima do elemento
